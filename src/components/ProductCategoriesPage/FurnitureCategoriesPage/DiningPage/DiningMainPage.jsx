...
import { VendorFilter, PriceFilter, MaterialsFilter, SizeFilter } from "./DiningStyled"
...
export const DiningMainPage = () => {
    const [DiningMainData, setDiningMainData] = useState([]);
    ...
    // }
    const sortData = () => {
        axios.get(`/diningroom/${sorting}`)
        .then(res => setDiningMainData(res.data))
        .catch(error => console.log("Error : ", error))
    }
    const getData = () => {
        axios.get("/diningroom")
        .then(res => setDiningMainData(res.data))
        
        .catch(error => console.log("Error : ", error))
    }
    console.log('DiningMainData:', DiningMainData)
    return (
        <div className="DiningMainContainer">
            <h1 className="DiningHeading">Dining Room & Bar Furniture</h1>
            ...
            <div className="Filtering__Grid-Container">
                ...
                <div className="Grid__Box">
                    {DiningMainData.map((element,index) => {
                        return (
                            <div key={index}>
                                    <div className="Grid__Box-Image">
                                    <a target={"_blank"} href={`/ProductDetails/diningroom/${element._id}`} style={{ textDecoration : "none"}}>
